...
- ### Contenedores.
  ...
  - `docker create -p 27017:27017 —name mongo -e MONGO_INITDB_ROOT_USERNAME=rafa -e MONGO_INITDB_ROOT_PASSWORD=password mongo`: Este comando indica crear un contenedor que permita el mapeo de puertos permitiendo acceder al puerto de mongodb (27017) desde la direccion IP (0.0.0.0:27017 o localhost:27017), el contenedor se llamará “mongo”, le indicará a la imagen de mongo mediante las variables de entorno de USERNAME y ROOT_PASSWORD el nombre usuario y las contraseña para acceder a la base de datos de mongo. Todo esto en la imagen de Mongo
...
```jsx
{
  Antes: "mongodb://rafa:password@localhost:27017/miapp?authSource=admin";
  Despues: "mongodb://rafa:password@mongoÏ:27017/miapp?authSource=admin";
}
